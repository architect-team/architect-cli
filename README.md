...
@architect-io/cli/0.1.5 darwin-x64 node-v10.15.0
...
_See code: [src/commands/init.ts](https://github.com/architect-team/architect-cli/blob/v0.1.5/src/commands/init.ts)_
...
_See code: [src/commands/install.ts](https://github.com/architect-team/architect-cli/blob/v0.1.5/src/commands/install.ts)_
...
_See code: [src/commands/start.ts](https://github.com/architect-team/architect-cli/blob/v0.1.5/src/commands/start.ts)_
<!-- commandsstop -->
