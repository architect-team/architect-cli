...
import { ComponentConfig } from '../../dependency-manager/src/spec/component/base';
import { ComponentConfigBuilder } from '../../dependency-manager/src/spec/component/builder';
