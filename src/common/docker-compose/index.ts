...
import IngressEdge from '../../dependency-manager/graph/edge/ingress';
import ComponentNode from '../../dependency-manager/graph/node/component';
import GatewayNode from '../../dependency-manager/graph/node/gateway';
