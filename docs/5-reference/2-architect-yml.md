...
| -------------------- | ---------- | -------------- | -------------- |
 ...
 | `protocol` | string | The protocol by which the component interface can be connected to. |  |
 | `username` | string | The Basic Auth username by which a component interface can be connected to. |  |
 | `password` | string | The Basic Auth password by which a component interface can be connected to. |  |
 | `url`* | string | The url that the component interface should forward to. |  |
