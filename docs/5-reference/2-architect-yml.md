...
| -------------------- | ---------- | -------------- | -------------- |
 ...
 | `default` | Array&lt;any&gt; \| boolean \| number \| object \| string \| null \| [Expression](/docs/reference/contexts) | Sets a default value for the secret if one is not provided |  |
...
| Field  (*=required)  | Type       | Description    | Misc           |
| -------------------- | ---------- | -------------- | -------------- |
 | `cpu` | number \| [Expression](/docs/reference/contexts) | The cpu usage required to trigger scaling. | [More](/docs/components/services/#cpu--memory) |
 | `memory` | number \| [Expression](/docs/reference/contexts) | The memory usage required to trigger scaling. | [More](/docs/components/services/#cpu--memory) |
